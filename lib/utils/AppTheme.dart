...
class AppThemeData {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(primary: appColorPrimary, onPrimary: appColorPrimary),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    visualDensity: VisualDensity.adaptivePlatformDensity,
    colorScheme: ColorScheme.dark(primary: appBackgroundColorDark, onPrimary: cardBackgroundBlackDark, onPrimaryContainer: color_primary_black).copyWith(secondary: whiteColor),
  ).copyWith(
    pageTransitionsTheme: PageTransitionsTheme(builders: <TargetPlatform, PageTransitionsBuilder>{
      TargetPlatform.android: OpenUpwardsPageTransitionsBuilder(),
      TargetPlatform.iOS: CupertinoPageTransitionsBuilder(),
